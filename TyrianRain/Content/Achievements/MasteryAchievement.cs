...
namespace TyrianRain.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => TyrianRain.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => TyrianRain.DEVELOPER_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
