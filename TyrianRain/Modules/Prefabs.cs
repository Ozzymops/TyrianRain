...
namespace TyrianRain.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = TyrianRain.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = TyrianRain.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = TyrianRain.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = TyrianRain.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            TyrianRain.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            TyrianRain.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            TyrianRain.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
        ...
        private static void SetupCameraTargetParams(GameObject prefab)
        {
            try
            {
                ...
                // bruh
                // aimmode
                cameraTargetParams.aimRequestStack.Add(cameraTargetParams.RequestAimType(CameraTargetParams.AimType.Standard));

                // ideallocalcamerapos bullshittery
                // - cameraTargetParams.idealLocalCameraPos = Vector3.zero;
                CharacterCameraParamsData characterCameraParamsData = prefab.GetComponent<CharacterCameraParamsData>();
