...
namespace TyrianRain.Modules
{
    internal static class Assets
    {
        ...
        // CHANGE THIS
        private const string mainAssetBundleName = "henryassetbundle";
        private const string csProjName = "TyrianRain";
        ...
        internal static void LoadAssetBundle()
        {
            try
            {
                ...
                {
                    using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"{csProjName}.{mainAssetBundleName}"))
                    {
