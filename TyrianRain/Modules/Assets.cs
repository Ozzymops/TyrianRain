...
namespace TyrianRain.Modules
{
    internal static class Assets
    {
        ...
        // CHANGE THIS
        private const string assetbundleName = "tyrianrainassets";
        ...
        internal static void LoadAssetBundle()
        {
            ...
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("TyrianRain." + assetbundleName))
                {
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("TyrianRain.HenryBank.bnk"))
            {
        ...
        public static Material CreateMaterial(string materialName, float emission, Color emissionColor, float normalStrength)
        {
            ...
            Debug.Log("Returning material " + mat.name);
            return mat;
        }
