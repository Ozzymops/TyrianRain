...
namespace TyrianRain.Modules.Survivors
{
    internal class Warrior : SurvivorBase
    {
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            armorGrowth = 0f,
            bodyName = "HenryBody",
            bodyNameToken = TyrianRain.developerPrefix + "_HENRY_BODY_NAME",
            ...
            jumpCount = 1,
            maxHealth = 110f,
            subtitleNameToken = TyrianRain.developerPrefix + "_HENRY_BODY_SUBTITLE",
            podPrefab = LegacyResourcesAPI.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod")
        };

        internal static Material henryMat = Modules.Assets.CreateMaterial("matHenry"); // matHenry
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(TyrianRain.developerPrefix + "_HENRY_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(TyrianRain.developerPrefix + "_HENRY_BODY_MASTERY_SKIN_NAME",
